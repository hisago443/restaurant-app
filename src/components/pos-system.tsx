...
export default function PosSystem({ 
  ...
  const handleItemClick = (item: MenuItem) => {
    if (interactionMode === 'click') {
      ...
      // For drag mode, clicking does nothing, user must drag.
      // Or we can open the quantity dialog. Let's keep it simple for now.
    }
  };
    ...
    const menuItemCard = (
      <Card
        ...
        className={cn(
          ...
          finalLightColor,
          interactionMode === 'click' ? 'cursor-pointer' : 'cursor-move'
        )}
